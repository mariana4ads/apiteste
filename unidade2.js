...
=======
        ...
        {
            pergunta: "Como devem ser escritas as tags no HTML?",
            respostas: [
                "Com letras maiúsculas",
                "Com letras minúsculas",
        ...
        {
            pergunta: "O que os espaços em branco fazem em HTML?",
            respostas: [
                "Servem para separar os termos",
                "Servem apenas para organizar o documento",
                "Não têm função específica",
                "Nenhuma das opções acima"
            ],
            correta: 0 // "Servem para separar os termos" é a resposta correta
        },
        {
            {
                "pergunta": "Qual é a função do elemento HTML <div>?",
